<?php if ($this->session->flashdata('action')) : ?>
    ...
    <div class="alert alert-<?= $this->session->flashdata('action')[0]; ?> alert-dismissible fade show                             <!-- Action Buttons -->
                <div class=" btn-group">
        <!-- Reset All Filters -->
        <?php if ($hasFilters) : ?>
        ...
        <!-- Download Excel -->
        <a href="<?= site_url('pneumatic/download'); ?>" class="btn btn-primary <?= $hasFilters ? '' : 'rounded-start-pill' ?>">Download</a>-- Action Buttons -->
        <div class=" btn-group">
            <!-- Reset All Filters -->
            ...
            <div class="card-footer bg-white border-0 px-lg-5 px-4 py-3">
                <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between gap-3">
                    ...
                    <div class="btn-group">
                        ...
                        <!-- Download Button -->
                        <a href="<?= site_url('pneumatic/download'); ?>" class="btn btn-primary <?= $hasFilters ? '' : 'rounded-start-pill' ?>">Download</a>
