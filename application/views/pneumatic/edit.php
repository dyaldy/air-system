    ...
    <div class="card-body p-4 pt-3">
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <div class="position-relative">
                    <input id="min_stock" type="number" class="form-control rounded-pill pe-5 <?= form_error('min_stock') ? 'is-invalid' : '' ?>" name="min_stock" placeholder="10" value="<?= set_value('min_stock') ? set_value('min_stock') : $pneumatic['min_stock']; ?>" onkeyup="toggleClear('min_stock', 'clear-button-min_stock')" autocomplete="off" min="0">
