            ...
            <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between gap-3">
                ...
                <div class="btn-group">
                    ...
                    <div class="btn-group" role="group">
                        <a href="<?= site_url('solenoid/download'); ?>" class="btn btn-primary <?= $hasFilters ? '' : 'rounded-start-pill' ?>" title="Download CSV">Download CSV</a>
                        <a href="<?= site_url('solenoid/downloadPDF'); ?>" class="btn btn-danger" title="Download PDF">Download PDF</a>
                    </div>
