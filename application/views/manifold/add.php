...
<div class="card mx-auto rounded-5 shadow border-0 mb-5 w-75" style="margin-top: 5rem;">
    ...
    <div class="card-header bg-transparent border-0 px-4 pt-3 pb-1">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <!-- Title -->
            <h4 class="m-0">Tambah Manifold Air System</h4>

            <!-- Back Button-->
            <?php
            // Determine back URL: use referer if available and from manifold pages, otherwise default to index
            $backUrl = site_url('manifold');
            if (
                !empty($_SERVER['HTTP_REFERER']) &&
                (strpos($_SERVER['HTTP_REFERER'], site_url('manifold')) !== false)
            ) {
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> Manifold ID akan dibuat otomatis berdasarkan format: mnf-block
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="position-relative">
                    <input id="block" type="number" class="form-control rounded-pill pe-5 <?= form_error('block') ? 'is-invalid' : '' ?>" name="block" placeholder="5" value="<?= set_value('block'); ?>" onkeyup="toggleClear('block', 'clear-button-block')" autocomplete="off" min="1">
